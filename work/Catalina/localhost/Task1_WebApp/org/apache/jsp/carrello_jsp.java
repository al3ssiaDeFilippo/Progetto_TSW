 ...
 * Generated at: 2024-07-22 12:16:45 UTC
...
public final class carrello_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("main.javas.util.Carrello");
    _jspx_imports_classes.add("main.javas.bean.UserBean");
    _jspx_imports_classes.add("main.javas.bean.ProductBean");
    _jspx_imports_classes.add("main.javas.bean.CartBean");
    _jspx_imports_classes.add("main.javas.model.Order.CartModel");
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    System.out.println("Total discount: " + totalDiscount);
      ...
      out.write("    <script src=\"js/UpdateQuantity.js\" defer></script>\r\n");
 ...
 for (CartBean prodotto : prodotti) {
      ...
      out.write("\r\n");
      out.write("        <div class=\"product-item-horizontal\">\r\n");
      ...
      out.write("&frame=");
      out.print( prodotto.getFrame() );
      out.write("&frameColor=");
      out.print( prodotto.getFrameColor() );
      out.write("\">\r\n");
      out.write("                    <img src=\"GetProductImageServlet?action=get&code=");
      out.print( product.getCode() );
      out.write("&frame=");
      out.print( prodotto.getFrame() );
      out.write("&frameColor=");
      out.print( prodotto.getFrameColor() );
      out.write("\" alt=\"Immagine attuale del prodotto\">\r\n");
      out.write("                </a>\r\n");
      out.write("            </div>\r\n");
      out.write("\r\n");
      out.write("\r\n");
      ...
      out.write("                    <p>Quantità:</p>\r\n");
      out.write("                    <input type=\"number\" name=\"quantity\" value=\"");
      out.print( prodotto.getQuantity() );
      out.write("\" min=\"1\" max=\"");
      out.print( model.ProductMaxQuantity(prodotto) );
      out.write("\" onchange=\"updateQuantity('");
      out.print( prodotto.getProductCode() );
      out.write("', this.value)\">\r\n");
      out.write("                </div>\r\n");
      out.write("\r\n");
      out.write("                <div class=\"product-frame\">Cornice: ");
      out.print( prodotto.getFrame() );
      out.write("</div>\r\n");
      out.write("                <div class=\"product-frame-color\">Colore del frame: ");
      out.print( prodotto.getFrameColor() );
      out.write("</div>\r\n");
      out.write("                <div class=\"product-size\">Dimensioni: ");
      out.print( prodotto.getSize() );
      out.write("</div>\r\n");
      out.write("\r\n");
      out.write("                <div class=\"product-price\" data-discount=\"");
      out.print( hasDiscount );
      out.write("\" data-price=\"");
      out.print( product.getPrice() );
      out.write("\" data-discounted-price=\"");
      out.print( model.getSingleProductDiscountedPrice(prodotto) );
      out.write("\">\r\n");
      out.write("                    ");
 if (!hasDiscount) { 
      out.write("\r\n");
      out.write("                    <!-- Prezzo totale di un prodotto senza sconto-->\r\n");
      out.write("                    <p class=\"price-label\">Prezzo unitario: <span class=\"product-total-price\">");
      out.print( model.getProductTotalPrice(prodotto) );
      out.write("€</span></p>\r\n");
      out.write("                    ");
 } else { 
      out.write("\r\n");
      out.write("                    <!-- Prezzo totale di un prodotto con sconto-->\r\n");
      out.write("                    <p class=\"price-label\">Prezzo unitario: <del class=\"original-price\">");
      out.print( model.getProductTotalPrice(prodotto) );
      out.write(" €</del> <span class=\"discounted-price\">");
      out.print( model.getSingleProductDiscountedPrice(prodotto) );
      out.write(" €</span> </p>\r\n");
      out.write("                    ");
 } 
      ...
      out.print( prodotto.getProductCode() );
      out.write("\">\r\n");
      out.write("                    <button type=\"submit\" class=\"icon-button\">\r\n");
      out.write("                        <img src=\"Images/binIcon.png\" alt=\"Rimuovi\">\r\n");
      out.write("                    </button>\r\n");
      out.write("                </form>\r\n");
      out.write("\r\n");
      out.write("            </div>\r\n");
      ...
      out.write("        <h2>Riepilogo</h2>\r\n");
      out.write("        <div class=\"summary-item\">\r\n");
      out.write("            <span>Subtotale</span>\r\n");
      out.write("            <span id=\"totalPriceWithoutDiscount\">");
      out.print( totalPriceWithoutDiscount );
      out.write(" €</span>\r\n");
      out.write("        </div>\r\n");
      out.write("\r\n");
      out.write("        <div class=\"summary-discount\">\r\n");
      out.write("            <span>Sconto</span>\r\n");
      out.write("            <span id=\"totalDiscount\">- ");
      out.print( totalDiscount );
      out.write(" €</span>\r\n");
      out.write("        </div>\r\n");
      out.write("\r\n");
      out.write("        <div class=\"summary-item\">\r\n");
      out.write("            <span>Costi di spedizione</span>\r\n");
      out.write("            <span>Gratis</span>\r\n");
      out.write("        </div>\r\n");
      out.write("\r\n");
      out.write("        <div class=\"summary-total\">\r\n");
      out.write("            <span>Totale</span>\r\n");
      out.write("            <span id=\"totalPrice\">");
      out.print( totalPriceWithDiscount );
      out.write(" €</span>\r\n");
      out.write("        </div>\r\n");
      out.write("\r\n");
      out.write("        ");
 ...
 if (errorMessage != null) { 
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("        <!--<form action=\"ServletCarrello\" method=\"post\">\r\n");
      out.write("            <input type=\"hidden\" name=\"action\" value=\"clear\">\r\n");
      out.write("            <input type=\"submit\" value=\"Svuota carrello\" class=\"btn\">\r\n");
      out.write("        </form>-->\r\n");
      out.write("\r\n");
      out.write("        ");
 if (cart.getProdotti().isEmpty()) { 
      ...
      out.write("\r\n");
      out.write("        <form action=\"CheckoutServlet\" method=\"get\">\r\n");
      out.write("            <input type=\"hidden\" name=\"nextPage\" value=\"CheckoutShipping.jsp\">\r\n");
      out.write("            <button type=\"submit\" class=\"btn-checkout\">Vai al pagamento</button>\r\n");
      out.write("        </form>\r\n");
      out.write("        ");
 } 
      out.write("\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("        <div class=\"payment-accepted\"><p>Modalità di pagamento disponibili</p></div>\r\n");
      out.write("\r\n");
      out.write("        <div class=\"payment-modes\">\r\n");
      out.write("            <img src=\"Images/masterCardIcon.png\" alt=\"MasterCard\">\r\n");
      out.write("            <img src=\"Images/visaIcon.png\" alt=\"Visa\">\r\n");
      out.write("            <img src=\"Images/postePayIcon.png\" alt=\"PostePay\">\r\n");
      out.write("        </div>\r\n");
      out.write("    </div>\r\n");
      out.write("</div>\r\n");
      out.write("\r\n");
