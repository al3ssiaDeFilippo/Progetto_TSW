 ...
 * Generated at: 2024-07-21 22:34:20 UTC
...
public final class DetailProductPage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("main.javas.model.Product.ProductModelDS");
    _jspx_imports_classes.add("main.javas.bean.UserBean");
    _jspx_imports_classes.add("main.javas.model.Product.FavoritesModel");
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    if (product != null) {
      ...
      out.write("    <link href=\"css/DetailProductPage.css\" rel=\"stylesheet\" type=\"text/css\">\r\n");
      out.write("    <script src=\"js/DetailSelection.js\" defer></script>\r\n");
      out.write("    <script src=\"js/ModalImage.js\" defer></script>\r\n");
    ...
    if (product != null) {
      ...
      out.write("        <img id=\"productImage\" data-product-code=\"");
      out.print( product.getCode() );
      out.write("\" src=\"");
      out.print( request.getContextPath());
      out.write("/GetProductImageServlet?action=get&code=");
      out.print( product.getCode() );
      out.write("&custom=true\" alt=\"image not found\">\r\n");
      out.write("    </div>\r\n");
      out.write("\r\n");
 ...
 if(product.getDiscount() > 0) { 
      out.write("\r\n");
      out.write("            <div class=\"discount-badge\">Sconto del ");
      out.print( product.getDiscount() );
      out.write("%</div>\r\n");
      out.write("            <p><strong>Prezzo:</strong> <span class=\"original-price\">");
      out.print( product.getPrice() );
      out.write(" €</span></p>\r\n");
      out.write("            <p><span class=\"discounted-price\">");
      out.print( discounted );
      out.write(" €</span></p>\r\n");
      out.write("            ");
 } else { 
      out.write("\r\n");
      out.write("            <p><strong>Prezzo:</strong> ");
      out.print( product.getPrice() );
      out.write(" €</p>\r\n");
      out.write("            ");
 } 
      out.write("\r\n");
      out.write("        </div>\r\n");
      out.write("        <!-- Aggiungi al Carrello e Preferiti -->\r\n");
      out.write("        ");
 if (product.getQuantity() > 0) { 
      out.write("\r\n");
      out.write("        <form action=\"");
      out.print( request.getContextPath() );
      out.write("/AddToCartServlet\" method=\"post\" onsubmit=\"return validateForm()\">\r\n");
      out.write("            <input type=\"hidden\" name=\"code\" value=\"");
      out.print( product.getCode() );
      out.write("\">\r\n");
      out.write("            <p><strong>Dimensioni:</strong>\r\n");
      out.write("                <select name=\"size\" id=\"sizeSelect\">\r\n");
      out.write("                    <option value=\"selectAsize\" disabled selected>Seleziona la dimensione</option>\r\n");
      out.write("                    <option value=\"21x30\">21x30</option>\r\n");
      out.write("                    <option value=\"85x60\">85x60</option>\r\n");
      out.write("                    <option value=\"91x61\">91x61</option>\r\n");
      out.write("                </select>\r\n");
      out.write("            </p>\r\n");
      out.write("            <p id=\"frameSelectContainer\"><strong>Materiale Cornice:</strong>\r\n");
      out.write("                <select name=\"frame\" id=\"frameSelect\">\r\n");
      out.write("                    <option value=\"no frame\" selected>No Frame</option>\r\n");
      out.write("                    <option value=\"wood\">Wood</option>\r\n");
      out.write("                    <option value=\"PVC\">PVC</option>\r\n");
      out.write("                </select>\r\n");
      out.write("            </p>\r\n");
      out.write("            <p id=\"frameColorSelectContainer\"><strong>Colore Cornice:</strong>\r\n");
      out.write("                <select name=\"frameColor\" id=\"frameColorSelect\">\r\n");
      out.write("                    <option value=\"no color\" style=\"display:none;\">No Color</option>\r\n");
      out.write("                    <option value=\"selectAframeColor\" disabled selected>Seleziona un colore per il frame</option>\r\n");
 ...
 if (user == null || !user.getAdmin()) { 
      out.write("\r\n");
      out.write("            <!-- Form for adding to cart, hidden for admins -->\r\n");
      out.write("            <p id=\"errorMessage\" style=\"color:red; display:none;\"></p>\r\n");
      out.write("            <input type=\"submit\" value=\"Aggiungi al Carrello\" class=\"add-to-cart-button\">\r\n");
      out.write("            ");
 } else { 
      out.write("\r\n");
      out.write("            <p class=\"admin-message\">Gli amministratori non possono aggiungere prodotti al carrello</p>\r\n");
      out.write("            ");
 } 
      out.write("\r\n");
      out.write("        </form>\r\n");
      ...
      out.write("\r\n");
      out.write("        <p class=\"unavailable-product\">Prodotto non disponibile al momento</p>\r\n");
      out.write("        ");
 } 
      out.write("\r\n");
      out.write("\r\n");
      out.write("        ");
 if (user != null && user.getAdmin()) { 
      out.write(" <!-- Show admin controls -->\r\n");
      out.write("        <form action=\"");
      out.print( request.getContextPath() );
      out.write("/DeleteProductServlet\" method=\"post\">\r\n");
      out.write("            <input type=\"hidden\" name=\"code\" value=\"");
      out.print( product.getCode() );
      out.write("\">\r\n");
      out.write("            <input type=\"submit\" class=\"delete-button\" value=\"Elimina\">\r\n");
      out.write("        </form>\r\n");
      out.write("        <form action=\"");
      out.print( request.getContextPath() );
      ...
      out.write("            <input type=\"submit\" class=\"modify-button\" value=\"Modifica\">\r\n");
      out.write("        </form>\r\n");
      out.write("        ");
 } 
      out.write("\r\n");
      ...
      out.write("    <h2>Dettagli del Prodotto</h2>\r\n");
      out.write("    <p>");
      out.print( product.getDetails() );
      out.write("</p>\r\n");
      out.write("</div>\r\n");
      ...
      out.write("\r\n");
      out.write("<p>Prodotto non trovato.</p>\r\n");
      ...
      out.write("        <img id=\"img01\" class=\"modal-image\">\r\n");
      out.write("    </div>\r\n");
      out.write("    <div id=\"caption\"></div>\r\n");
      out.write("</div>\r\n");
      out.write("\r\n");
      out.write("<!-- Sezione Best Seller -->\r\n");
      out.write("<div class=\"best-seller-section\">\r\n");
      out.write("    <div class=\"best-seller-title\">Prodotti correlati: </div>\r\n");
      ...
      out.write("                    <a href=\"");
      out.print( request.getContextPath() );
      out.write("/RetrieveProductServlet?action=read&code=");
      out.print(products.getCode());
      out.write("\">\r\n");
      out.write("                        <img src=\"");
      out.print( request.getContextPath() );
      out.write("/GetProductImageServlet?action=get&code=");
