 ...
 * Generated at: 2024-07-22 12:30:18 UTC
...
public final class EditProductPage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("main.javas.bean.ProductBean");
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("    <meta enctype=\"multipart/form-data\">\r\n");
      out.write("    <link rel=\"stylesheet\" type=\"text/css\" href=\"css/EditProductPage.css\">\r\n");
      out.write("    <title>Modifica Prodotto</title>\r\n");
      out.write("    <script src=\"js/UploadImage.js\" defer></script>\r\n");
      out.write("    <script>\r\n");
      out.write("        function previewImage(event) {\r\n");
      out.write("            const reader = new FileReader();\r\n");
      out.write("            reader.onload = function() {\r\n");
      out.write("                const output = document.getElementById('productImage');\r\n");
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("<h2>Modifica Prodotto</h2>\r\n");
      out.write("<div class=\"as\">\r\n");
      out.write("<form action=\"");
      out.print( request.getContextPath() );
      out.write("/UpdateProductServlet\" method=\"post\" enctype=\"multipart/form-data\">\r\n");
      out.write("    <input type=\"hidden\" name=\"action\" value=\"update\">\r\n");
      out.write("\r\n");
      out.write("    <input type=\"hidden\" id=\"productCode\" name=\"code\" value=\"");
      out.print(request.getAttribute("product") != null ? ((ProductBean) request.getAttribute("product")).getCode() : "" );
      out.write("\">\r\n");
      out.write("\r\n");
      out.write("    <label for=\"productName\">Nome:</label><br>\r\n");
      out.write("    <input type=\"text\" id=\"productName\" name=\"productName\" value=\"");
      out.print(request.getAttribute("product") != null ? ((ProductBean) request.getAttribute("product")).getProductName() : "" );
      out.write("\"><br>\r\n");
      out.write("\r\n");
      out.write("    <label for=\"details\">Dettagli:</label><br>\r\n");
      out.write("    <input type=\"text\" id=\"details\" name=\"details\" value=\"");
      out.print(request.getAttribute("product") != null ? ((ProductBean) request.getAttribute("product")).getDetails() : "" );
      out.write("\"><br>\r\n");
      out.write("\r\n");
      out.write("    <label for=\"quantity\">Quantità:</label><br>\r\n");
      out.write("    <input type=\"number\" id=\"quantity\" name=\"quantity\" value=\"");
      out.print(request.getAttribute("product") != null ? ((ProductBean) request.getAttribute("product")).getQuantity() : "" );
      out.write("\"><br>\r\n");
      out.write("\r\n");
      out.write("    <label for=\"category\">Categoria:</label><br>\r\n");
      out.write("    <select id=\"category\" name=\"category\">\r\n");
      out.write("        <option value=\"selectACategory\" disabled>Seleziona una categoria</option>\r\n");
      out.write("        <option value=\"Film\" ");
      out.print(request.getAttribute("product") != null && ((ProductBean) request.getAttribute("product")).getCategory().equals("Film") ? "selected" : "");
      out.write(">Film</option>\r\n");
      out.write("        <option value=\"Anime\" ");
      out.print(request.getAttribute("product") != null && ((ProductBean) request.getAttribute("product")).getCategory().equals("Anime") ? "selected" : "");
      out.write(">Anime</option>\r\n");
      out.write("        <option value=\"Giochi\" ");
      out.print(request.getAttribute("product") != null && ((ProductBean) request.getAttribute("product")).getCategory().equals("Giochi") ? "selected" : "");
      out.write(">Giochi</option>\r\n");
      out.write("        <option value=\"Serie TV\" ");
      out.print(request.getAttribute("product") != null && ((ProductBean) request.getAttribute("product")).getCategory().equals("Serie TV") ? "selected" : "");
      out.write(">Serie TV</option>\r\n");
      out.write("        <option value=\"Fumetti\" ");
      out.print(request.getAttribute("product") != null && ((ProductBean) request.getAttribute("product")).getCategory().equals("Fumetti") ? "selected" : "");
      out.write(">Fumetti</option>\r\n");
      out.write("    </select><br>\r\n");
      out.write("\r\n");
      out.write("    <label for=\"price\">Prezzo:</label><br>\r\n");
      out.write("    <input type=\"number\" id=\"price\" name=\"price\" value=\"");
      out.print(request.getAttribute("product") != null ? ((ProductBean) request.getAttribute("product")).getPrice() : "" );
      out.write("\" step=\"0.01\"><br>\r\n");
      out.write("\r\n");
      out.write("    <label for=\"iva\">IVA:</label><br>\r\n");
      out.write("    <input type=\"number\" id=\"iva\" name=\"iva\" value=\"");
      out.print(request.getAttribute("product") != null ? ((ProductBean) request.getAttribute("product")).getIva() : "" );
      out.write("\"><br>\r\n");
      out.write("\r\n");
      out.write("    <label for=\"discount\">Sconto:</label><br>\r\n");
      out.write("    <input type=\"number\" id=\"discount\" name=\"discount\" value=\"");
      out.print(request.getAttribute("product") != null ? ((ProductBean) request.getAttribute("product")).getDiscount() : "" );
      out.write("\" step=\"0.01\"><br>\r\n");
      out.write("\r\n");
      out.write("    <!-- Caricamento nuova immagine -->\r\n");
      out.write("    <label for=\"photoPath\">Foto:</label><br>\r\n");
      out.write("    <input type=\"file\" id=\"photoPath\" name=\"photoPath\" accept=\".jpg\"   onchange=\"previewImage(event)\"><br>\r\n");
      out.write("\r\n");
      out.write("    <!-- Mostra l'immagine attuale del prodotto -->\r\n");
      out.write("    <img id=\"productImage\" class=\"product-image\" src=\"");
      out.print( request.getContextPath() );
      out.write("/GetProductImageServlet?action=get&code=");
      out.print(request.getAttribute("product") != null ? ((ProductBean) request.getAttribute("product")).getCode() : "" );
      out.write("\" alt=\"Immagine attuale del prodotto\"><br>\r\n");
      out.write("    <input type=\"hidden\" name=\"currentPhoto\" value=\"");
      out.print(request.getAttribute("product") != null && ((ProductBean) request.getAttribute("product")).getPhoto() != null ? "true" : "false");
      out.write("\">\r\n");
      out.write("\r\n");
      out.write("    <div class=\"button-container\">\r\n");
      out.write("        <input type=\"submit\" value=\"Modifica Prodotto\">\r\n");
      out.write("    </div>\r\n");
      out.write("</div>\r\n");
      out.write("\r\n");
      out.write("</form>\r\n");
